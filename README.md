...
# 🧾 Calculadora de Imposto de Renda — Brasil 2026

Aplicação desktop em Java com interface gráfica (Swing) que calcula o **Imposto de Renda Retido na Fonte (IRRF)** mensal com base na tabela progressiva de 2026, incluindo a nova regra de isenção para salários brutos até R$ 5.000,00 e suporte a múltiplos vínculos empregatícios.

---

## ✨ Funcionalidades

- ✅ Cálculo do IRRF com a **tabela progressiva de 2026**
...
|---|---|---|---|
| Até R$ 3.036,00 | Até R$ 2.428,80 | Isento | — |
| R$ 3.036,01 – R$ 3.433,85 | R$ 2.259,21 – R$ 2.826,65 | 7,5% | R$ 169,44 |
| R$ 3.433,86 – R$ 4.358,25 | R$ 2.826,66 – R$ 3.751,05 | 15% | R$ 381,44 |
| R$ 4.358,26 – R$ 5.271,88 | R$ 3.751,06 – R$ 4.664,68 | 22,5% | R$ 662,77 |
| Acima de R$ 5.271,88 | Acima de R$ 4.664,68 | 27,5% | R$ 896,00 |

> *Base de cálculo = Salário bruto − desconto simplificado de R$ 607,20
...
| R$ 5.001,00 – R$ 7.350,00 | Redutor progressivo (isenção parcial decrescente) |
| Acima de R$ 7.350,00 | Tabela progressiva plena, sem redutor |
...
📋  BASE DE CÁLCULO
  ...
  (=) Valor base de cálculo:  R$ 5.892,80

📊  FAIXA APLICADA
  27,5% — base acima de R$ 4.664,68

🧮  CÁLCULO DO IMPOSTO
  Imposto bruto (base × 27,5%):  R$ 1.620,52
  (-) Parcela a deduzir tabela:  R$   908,73
  (=) Imposto após tabela:       R$   711,79
  (-) Redutor nova lei (2025):   R$   113,18

─────────────────────────────────────
💰  IMPOSTO A RECOLHER:      R$ 598,61
  Alíquota efetiva:           9,21%
  Salário líquido estimado:   R$ 5.901,39
```
...
─────────────────────────────────────
  Total bruto (soma):          R$ 7.500,00
  Total IR retido:             R$     0,00

⚠️  IMPOSTO REAL SOBRE RENDA TOTAL
─────────────────────────────────────
  IR devido sobre total:       R$   986,79
...
Este projeto é um exercício acadêmico. Os valores e alíquotas implementados são baseados na legislação vigente em 2026, mas **não substituem orientação de um contador ou da Receita Federal**. Consulte sempre um profissional para situações reais.
